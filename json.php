...
$current_addr = "http://androidfiles3.org". "" .$_SERVER['REQUEST_URI'];
...
if($dev == "Gapps"){
$url = "http://androidfiles3.org/?developer=".$dev;
...
$res = strstr($gurl, "<div style='float: left; margin-left: 10px; width: 668px'>");
	...
	$url = 'http://androidfiles3.org/'.$url;
...
$url = "http://androidfiles3.org/?developer=".$dev."&folder=".$device;
